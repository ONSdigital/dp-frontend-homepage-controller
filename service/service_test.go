	...
	Convey("Having a set of mocked dependencies", t, func() {
		...
		Convey("Given that Checkers cannot be registered", func() {
			...
			Convey("Then service Run fails, but all checks try to register", func() {
				...
				So(hcMockAddFail.AddCheckCalls()[2].Name, ShouldResemble, "Babbage")
				So(hcMockAddFail.AddCheckCalls()[3].Name, ShouldResemble, "API Router (to access Image API)")
			})
		})
		...
		Convey("Given that all dependencies are successfully initialised", func() {
			...
			Convey("The checkers are registered and the healthcheck and http server started", func() {
				...
				So(hcMock.AddCheckCalls()[2].Name, ShouldResemble, "Babbage")
				So(hcMock.AddCheckCalls()[3].Name, ShouldResemble, "API Router (to access Image API)")
