...
var (
	lockBabbageClientMockChecker            sync.RWMutex
...
// Checker calls CheckerFunc.
func (mock *BabbageClientMock) Checker(ctx context.Context, check *healthcheck.CheckState) error {
	if mock.CheckerFunc == nil {
	...
	lockBabbageClientMockChecker.Lock()
	mock.calls.Checker = append(mock.calls.Checker, callInfo)
	lockBabbageClientMockChecker.Unlock()
	return mock.CheckerFunc(ctx, check)
}
...
func (mock *BabbageClientMock) CheckerCalls() []struct {
	...
	lockBabbageClientMockChecker.RLock()
	calls = mock.calls.Checker
	lockBabbageClientMockChecker.RUnlock()
	return calls
}
