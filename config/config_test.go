	...
	Convey("Given an environment with no environment variables set", t, func() {
		...
		Convey("When the config values are retrieved", func() {
			...
			Convey("That the values should be set to the expected defaults", func() {
				...
				So(cfg.PatternLibraryAssetsPath, ShouldEqual, "//cdn.ons.gov.uk/dp-design-system/efc4b51")
				...
				So(cfg.CensusFirstResults, ShouldEqual, "Wednesday, 27-Jul-23 11:00:00 BST")
			})
		})
	})
}
